...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    getAllNewsItem().then(res => {
      ...
      }, ()=>console.log("allNewsItem: "+JSON.stringify(this.state.allNewsItem)))
    }).catch(() => {
  ...
  render() {
    const {
      ...
      renderDirectInput, renderFurnitureInput, renderInputContact, renderInputProject, summary, address, currentUser
    } = this.state;
    let inputAddress;
    let inputFloor;
    let inputRoom;
